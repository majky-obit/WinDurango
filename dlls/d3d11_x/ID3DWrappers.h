...
namespace d3d11x
{
	...
	public:
		...
		virtual INT (PIXBeginEvent)(
			_In_ LPCWSTR Name)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXBeginEvent NOT IMPLEMENTED\n");
			return 0;
		}
		...
		virtual INT (PIXBeginEventEx)(
			...
			_In_ UINT DataSize)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXBeginEventEx NOT IMPLEMENTED\n");
			return 0;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXEndEvent NOT IMPLEMENTED\n");
			return 0;
		}
		...
		virtual void (PIXSetMarker)(
			_In_ LPCWSTR Name)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXSetMarker NOT IMPLEMENTED\n");
		}
		...
		virtual void (PIXSetMarkerEx)(
			...
			_In_ UINT DataSize)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXSetMarkerEx NOT IMPLEMENTED\n");
		}

		virtual BOOL (PIXGetStatus)(
			_Inout_ ID3D11DeviceContextX* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXGetStatus NOT IMPLEMENTED\n");
			return 0;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXGpuCaptureNextFrame NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		virtual HRESULT (PIXGpuBeginCapture)(
			...
			_In_z_ LPCWSTR lpOutputFileName)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXGpuBeginCapture NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		virtual HRESULT (PIXGpuEndCapture)(
			_Inout_ ID3D11DeviceContextX* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PIXGpuEndCapture NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] StartCounters NOT IMPLEMENTED\n");
		}

		virtual void (SampleCounters)(
			_In_ ID3D11CounterSampleX* pCounterSample)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SampleCounters NOT IMPLEMENTED\n");
		}

		virtual void (StopCounters)(
			_Inout_ ID3D11DeviceContextX* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] StopCounters NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GetCounterData NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		virtual void (FlushGpuCaches)(
			_In_ ID3D11Resource* pResource)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] FlushGpuCaches NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] FlushGpuCacheRange NOT IMPLEMENTED\n");
		}

		virtual void (InsertWaitUntilIdle)(
			_In_ UINT Flags)
		{
			//DEBUGPRINT("[ID3D11DeviceContextX] InsertWaitUntilIdle NOT IMPLEMENTED\n");
		}

		virtual UINT64 (InsertFence)(
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertFence NOT IMPLEMENTED\n");
			return 0;
		}
		...
		virtual void (InsertWaitOnFence)(
			...
			_In_ UINT64 Fence)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertWaitOnFence NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RemapConstantBufferInheritance NOT IMPLEMENTED\n");
		}
		...
		virtual void (RemapShaderResourceInheritance)(
			...
			_In_ UINT InheritSlot)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RemapShaderResourceInheritance NOT IMPLEMENTED\n");
		}
		...
		virtual void (RemapSamplerInheritance)(
			...
			_In_ UINT InheritSlot)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RemapSamplerInheritance NOT IMPLEMENTED\n");
		}
		...
		virtual void (RemapVertexBufferInheritance)(
			...
			_In_ UINT InheritSlot)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RemapVertexBufferInheritance NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (PSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (VSSetFastConstantBuffer)(
			...
			_In_ ID3D11Buffer* pConstantBuffer)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (VSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (VSSetFastSampler)(
			...
			_In_ ID3D11SamplerState* pSampler)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetFastConstantBuffer)(
			...
			_In_ ID3D11Buffer* pConstantBuffer)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetFastSampler)(
			...
			_In_ ID3D11SamplerState* pSampler)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetFastConstantBuffer)(
			...
			_In_ ID3D11Buffer* pConstantBuffer)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetFastSampler)(
			...
			_In_ ID3D11SamplerState* pSampler)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetFastConstantBuffer)(
			...
			_In_ ID3D11Buffer* pConstantBuffer)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetFastSampler)(
			...
			_In_ ID3D11SamplerState* pSampler)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetFastConstantBuffer)(
			...
			_In_ ID3D11Buffer* pConstantBuffer)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetFastConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetFastShaderResource)(
			...
			_In_ ID3D11ShaderResourceView* pShaderResourceView)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetFastShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetFastSampler)(
			...
			_In_ ID3D11SamplerState* pSampler)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetFastSampler NOT IMPLEMENTED\n");
		}
		...
		virtual void (IASetFastVertexBuffer)(
			...
			_In_ UINT Stride)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] IASetFastVertexBuffer NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] IASetFastIndexBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (PSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (PSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (VSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (VSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetPlacementConstantBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetPlacementConstantBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetPlacementShaderResource)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetPlacementShaderResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (IASetPlacementVertexBuffer)(
			...
			_In_ UINT Stride)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] IASetPlacementVertexBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (IASetPlacementIndexBuffer)(
			...
			_In_ void* pBaseAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] IASetPlacementIndexBuffer NOT IMPLEMENTED\n");
		}

		virtual void (HSSetTessellationParameters)(
			_In_opt_ const D3D11X_TESSELLATION_PARAMETERS* pTessellationParameters)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetTessellationParameters NOT IMPLEMENTED\n");
		}

		virtual void (HSGetLastUsedTessellationParameters)(
			_Inout_ D3D11X_TESSELLATION_PARAMETERS* pTessellationParameters)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSGetLastUsedTessellationParameters NOT IMPLEMENTED\n");
		}

		virtual void (CSEnableAutomaticGpuFlush)(
			_In_ BOOL Enable)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSEnableAutomaticGpuFlush NOT IMPLEMENTED\n");
		}

		virtual void (GpuSendPipelinedEvent)(
			_In_ D3D11X_GPU_PIPELINED_EVENT Event)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GpuSendPipelinedEvent NOT IMPLEMENTED\n");
		}

		virtual HRESULT (Suspend)(
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] Suspend NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		virtual HRESULT (Resume)(
			_Inout_ ID3D11DeviceContextX* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] Resume NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		virtual void (BeginCommandListExecution)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] BeginCommandListExecution NOT IMPLEMENTED\n");
		}

		virtual void (EndCommandListExecution)(
			_Inout_ ID3D11DeviceContext* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] EndCommandListExecution NOT IMPLEMENTED\n");
		}

		virtual void (SetGraphicsShaderLimits)(
			_In_opt_ const D3D11X_GRAPHICS_SHADER_LIMITS* pShaderLimits)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetGraphicsShaderLimits NOT IMPLEMENTED\n");
		}

		virtual void (SetComputeShaderLimits)(
			_In_opt_ const D3D11X_COMPUTE_SHADER_LIMITS* pShaderLimits)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetComputeShaderLimits NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetPredicationBuffer)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetPredicationBuffer NOT IMPLEMENTED\n");
		}
		...
		virtual void (OMSetDepthBounds)(
			...
			_In_ FLOAT max)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] OMSetDepthBounds NOT IMPLEMENTED\n");
		}

		virtual void (OMSetDepthStencilStateX)(
			_In_opt_ ID3D11DepthStencilState* pDepthStencilState)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] OMSetDepthStencilStateX NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] OMSetSampleMask NOT IMPLEMENTED\n");
		}

		virtual UINT32* (MakeCeSpace)(
			_Inout_ ID3D11DeviceContextX* pDeviceContext)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] MakeCeSpace NOT IMPLEMENTED\n");
			return nullptr;
		}
		...
		virtual void (SetFastResources_Debug)(
			...
			_In_ UINT* pTableEnd)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetFastResources_Debug NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] BeginResourceBatch NOT IMPLEMENTED\n");
		}

		virtual UINT (EndResourceBatch)(
			_Out_opt_ UINT* pSizeNeeded)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] EndResourceBatch NOT IMPLEMENTED\n");
			return 0;
		}
		...
		virtual void (SetFastResourcesFromBatch_Debug)(
			...
			_In_ UINT Size)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetFastResourcesFromBatch_Debug NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSPlaceUnorderedAccessView)(
			...
			_In_ UINT64 Offset)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSPlaceUnorderedAccessView NOT IMPLEMENTED\n");
		}
		...
		virtual void (WriteValueEndOfPipe)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteValueEndOfPipe NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CopyMemoryToMemory NOT IMPLEMENTED\n");
		}
		...
		virtual void (FillMemoryWithValue)(
			...
			_In_ UINT FillValue)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] FillMemoryWithValue NOT IMPLEMENTED\n");
		}
		...
		virtual void (BeginProcessVideoResource)(
			...
			_In_ UINT SubResource)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] BeginProcessVideoResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (EndProcessVideoResource)(
			...
			_In_ UINT SubResource)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] EndProcessVideoResource NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] StartThreadTrace NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] StopThreadTrace NOT IMPLEMENTED\n");
		}

		virtual void (InsertThreadTraceMarker)(
			_In_ UINT Marker)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertThreadTraceMarker NOT IMPLEMENTED\n");
		}

		virtual void (IASetPrimitiveResetIndex)(
			_In_ UINT ResetIndex)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] IASetPrimitiveResetIndex NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetShaderResourceViewMinLOD)(
			...
			FLOAT MinLOD)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetShaderResourceViewMinLOD NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertWaitOnPresent NOT IMPLEMENTED\n");
		}
		...
		virtual void (ClearRenderTargetViewX)(
			...
			_In_ const FLOAT ColorRGBA[4])
		{
			DEBUGPRINT("[ID3D11DeviceContextX] ClearRenderTargetViewX NOT IMPLEMENTED\n");
		}

		virtual UINT (GetResourceCompression)(
			_In_ ID3D11Resource* pResource)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GetResourceCompression NOT IMPLEMENTED\n");
			return 0;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GetResourceCompressionX NOT IMPLEMENTED\n");
			return 0;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DecompressResource NOT IMPLEMENTED\n");
		}
		...
		virtual void (DecompressResourceX)(
			...
			_In_ UINT DecompressFlags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DecompressResourceX NOT IMPLEMENTED\n");
		}

		virtual void (GSSetParameters)(
			_In_opt_ const D3D11X_GS_PARAMETERS* pGsParameters)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetParameters NOT IMPLEMENTED\n");
		}

		virtual void (GSGetLastUsedParameters)(
			_Inout_ D3D11X_GS_PARAMETERS* pGsParameters)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSGetLastUsedParameters NOT IMPLEMENTED\n");
		}
		...
		virtual void (MultiDrawIndexedInstancedIndirect)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] MultiDrawIndexedInstancedIndirect NOT IMPLEMENTED\n");
		}
		...
		virtual void (MultiDrawInstancedIndirect)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] MultiDrawInstancedIndirect NOT IMPLEMENTED\n");
		}
		...
		virtual void (MultiDrawIndexedInstancedIndirectAuto)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] MultiDrawIndexedInstancedIndirectAuto NOT IMPLEMENTED\n");
		}
		...
		virtual void (MultiDrawInstancedIndirectAuto)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] MultiDrawInstancedIndirectAuto NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RSGetMSAASettingsForQuality NOT IMPLEMENTED\n");
			return E_NOTIMPL;
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RSSetScanConverterMSAASettings NOT IMPLEMENTED\n");
		}

		virtual void (RSSetEQAASettings)(
			_In_ const D3D11X_MSAA_EQAA_SETTINGS* pEQAASettings)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RSSetEQAASettings NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] RSSetSamplePositions NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetResourceCompression NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetResourceCompressionX)(
			...
			_In_ UINT Compression)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetResourceCompressionX NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetGDSRange)(
			...
			_In_ UINT NumDwords)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetGDSRange NOT IMPLEMENTED\n");
		}
		...
		virtual void (WriteGDS)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteGDS NOT IMPLEMENTED\n");
		}
		...
		virtual void (ReadGDS)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] ReadGDS NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] VSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (HSSetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] HSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (DSSetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] DSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (GSSetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] GSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (PSSetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] PSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (CSSetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CSSetShaderUserData NOT IMPLEMENTED\n");
		}
		...
		virtual void (InsertWaitOnMemory)(
			...
			_In_ UINT Mask)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertWaitOnMemory NOT IMPLEMENTED\n");
		}

		virtual void (WriteTimestampToMemory)(
			_In_ void* pDstAddress)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteTimestampToMemory NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteTimestampToBuffer NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] StoreConstantRam NOT IMPLEMENTED\n");
		}
		...
		virtual void (LoadConstantRam)(
			...
			_In_ UINT SizeInBytes)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] LoadConstantRam NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteQuery NOT IMPLEMENTED\n");
		}
		...
		virtual void (ResetQuery)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] ResetQuery NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] ConfigureQuery NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetShaderUserData)(
			...
			_In_reads_(NumRegisters) const UINT* pData)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetShaderUserData NOT IMPLEMENTED\n");
		}

		virtual void (SetPixelShaderDepthForceZOrder)(
			_In_ BOOL ForceOrder)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetPixelShaderDepthForceZOrder NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetPredicationFromQuery)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetPredicationFromQuery NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetBorderColorPalette)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetBorderColorPalette NOT IMPLEMENTED\n");
		}
		...
		virtual void (WriteValueEndOfPipe64)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] WriteValueEndOfPipe64 NOT IMPLEMENTED\n");
		}
		...
		{
			DEBUGPRINT("[ID3D11DeviceContextX] InsertWaitOnMemory64 NOT IMPLEMENTED\n");
		}
		...
		virtual void (LoadConstantRamImmediate)(
			...
			_In_ UINT SizeInBytes)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] LoadConstantRamImmediate NOT IMPLEMENTED\n");
		}

		virtual void (SetScreenExtentsQuery)(
			_In_ UINT Value)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetScreenExtentsQuery NOT IMPLEMENTED\n");
		}
		...
		virtual void (CollectScreenExtents)(
			...
			_In_ USHORT ZMax)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] CollectScreenExtents NOT IMPLEMENTED\n");
		}
		...
		virtual void (FillResourceWithValue)(
			...
			_In_ UINT FillValue)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] FillResourceWithValue NOT IMPLEMENTED\n");
		}
		...
		virtual void (SetDrawBalancing)(
			...
			_In_ UINT Flags)
		{
			DEBUGPRINT("[ID3D11DeviceContextX] SetDrawBalancing NOT IMPLEMENTED\n");
		}
		...
		HRESULT QueryInterface(REFIID riid, void** ppvObject) override
		{
			...
			DEBUGPRINT("[ID3D11DeviceContextXWrapperX] QueryInterface: %s\n", iidstr);
		...
		ULONG AddRef() override
		{
			DEBUGPRINT("[ID3D11DeviceContextXWrapperX] --> AddRef\n");
			return InterlockedIncrement(&m_RefCount);
		}

		ULONG Release() override
		{
			DEBUGPRINT("[ID3D11DeviceContextXWrapperX] --> Release\n");
		...
		{
			DEBUGPRINT("[ID3D11Texture2DWrapper]: SetName STUB\n");
			return S_OK;
		}
