...
namespace winrt::Microsoft::Xbox::Services::implementation
{
    ...
    winrt::Windows::Foundation::Uri XboxServiceCallRoutedEventArgs::Url()
    {
        throw hresult_not_implemented();
    }
    ...
    winrt::Microsoft::Xbox::Services::HttpCallRequestMessage XboxServiceCallRoutedEventArgs::RequestBody()
    {
        throw hresult_not_implemented();
    }
    ...
    winrt::Windows::Foundation::DateTime XboxServiceCallRoutedEventArgs::RequestTimeUTC()
    {
        throw hresult_not_implemented();
    }
    winrt::Windows::Foundation::DateTime XboxServiceCallRoutedEventArgs::ResponseTimeUTC()
    {
        throw hresult_not_implemented();
    }
    winrt::Windows::Foundation::TimeSpan XboxServiceCallRoutedEventArgs::ElapsedCallTime()
    {
        throw hresult_not_implemented();
    }
