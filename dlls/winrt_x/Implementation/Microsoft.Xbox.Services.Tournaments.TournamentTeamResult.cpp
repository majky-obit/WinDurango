...
{
    winrt::Microsoft::Xbox::Services::Tournaments::TournamentGameResultState TournamentTeamResult::State()
    {
        LOG_NOTIMPLEMENTED(); throw hresult_not_implemented();
    }
    void TournamentTeamResult::State(winrt::Microsoft::Xbox::Services::Tournaments::TournamentGameResultState const& value)
    {
        LOG_NOTIMPLEMENTED(); throw hresult_not_implemented();
    }
