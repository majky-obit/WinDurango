...
namespace winrt::Microsoft::Xbox::Services::Social::Manager::implementation
{
    ...
    winrt::Microsoft::Xbox::Services::Social::Manager::SocialManagerPresenceRecord XboxSocialUser::PresenceRecord()
    {
        throw hresult_not_implemented();
    }
    winrt::Microsoft::Xbox::Services::Social::Manager::TitleHistory XboxSocialUser::TitleHistory()
    {
        throw hresult_not_implemented();
    }
    winrt::Microsoft::Xbox::Services::Social::Manager::PreferredColor XboxSocialUser::PreferredColor()
    {
        throw hresult_not_implemented();
    }
}
